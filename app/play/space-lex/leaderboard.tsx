 ...
 * 
 * Displays three separate leaderboards based on wave difficulty:
 * - Easy: Waves 1-5 (Secteurs 1-5)
 * - Medium: Waves 6-10 (Secteurs 6-10)
 * - Hard: Waves 11+ (Secteurs 11+)
 * 
 * Each leaderboard shows:
 * - Top players ranked by best score
 * - Username, best score, max wave, and number of games played
 */
...
interface LexiconBlasterLeaderboardProps {
    initialDifficulty?: Difficulty;
}

export function LexiconBlasterLeaderboard({ initialDifficulty = "easy" }: LexiconBlasterLeaderboardProps) {
    ...
    useEffect(() => {
        async function fetchLeaderboards() {
          ...
          `)
                ...
                // Group by user_id and calculate best score, max wave, and games played
                ...
                for (const entry of scores) {
                    ...
                    const wave = entry.max_score || 1; // max_score stores wave reached
        ...
        <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-3 justify-center">
                    {(["easy", "medium", "hard"] as Difficulty[]).map((diff) => (
                        <button
                            ...
                            className={`comic-button px-6 py-2 font-bold text-outline ${selectedDifficulty === diff
            ...
            <div className="comic-panel-dark p-6">
                <h3 className="text-2xl font-bold text-white mb-6 text-outline text-center">
                    🏆 Top 10 - {DIFFICULTY_LABELS[selectedDifficulty]}
                </h3>
