...
/**
 * Simple Avatar Component for Lexicon Blaster Leaderboard
...
export function LeaderboardAvatar({
    ...
    return (
        <div
            className={`relative flex items-center justify-center rounded-full border-2 border-black ${classes.container} ${background?.image_url
                    ? "bg-cover bg-center"
                    : background?.color_theme
                        ? getItemColor(background.color_theme)
                        : "bg-gradient-to-br from-cyan-950/30 to-blue-900/30 border-cyan-800/40"
                }`}
            style={
