                        ...
                        {palier.courses.map((course) => {
                          ...
                          return (
                            <Link
                              ...
                              className="comic-card-dark group relative p-5 transition-transform duration-200 hover:scale-105 flex flex-col items-center text-center h-full"
                            ...
                            >
                              <div className="relative z-10 w-full flex flex-col items-center flex-grow">
                                ...
                                <div className="mb-3 md:mb-4 flex-grow flex items-center justify-center px-2">
                                  <h3 className="text-sm md:text-base font-bold text-white text-outline line-clamp-3 leading-tight text-balance" style={{ textShadow: '0 2px 4px rgba(0, 0, 0, 0.8), 0 0 8px rgba(0, 0, 0, 0.6)' }}>
                                    {course.title}
                                  </h3>
                                </div>

                                {/* CTA Button */}
                                <div className="comic-button bg-emerald-600 text-white px-3 py-2 md:px-4 md:py-2.5 text-xs md:text-sm font-bold hover:bg-emerald-700 w-full mt-auto">
                                  Voir le cours
                                </div>
                              </div>
                            </Link>
